...
public class PropertyImpl extends EObjectImpl implements Property {
	...
	/**
	 * This is true if the Isheader attribute has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	public void setIsheader(boolean newIsheader) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MessagePackage.PROPERTY__ISHEADER, oldIsheader, isheader, !oldIsheaderESet));
	}
	...
	public void unsetIsheader() {
		...
		isheaderESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MessagePackage.PROPERTY__ISHEADER, oldIsheader, ISHEADER_EDEFAULT, oldIsheaderESet));
	}
	...
	public String toString() {
		...
		if (isheaderESet) result.append(isheader); else result.append("<unset>");
		result.append(", name: ");
		result.append(name);
		result.append(", value: ");
		result.append(value);
