 ...
 *   <li>{@link org.fusesource.tools.core.message.impl.MessageImpl#getProviderId <em>Provider Id</em>}</li>
 *   <li>{@link org.fusesource.tools.core.message.impl.MessageImpl#getProviderName <em>Provider Name</em>}</li>
...
public class MessageImpl extends EObjectImpl implements Message {
	...
	public NotificationChain basicSetProperties(Properties newProperties, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MessagePackage.MESSAGE__PROPERTIES, oldProperties, newProperties);
	...
	public void setProperties(Properties newProperties) {
		if (newProperties != properties) {
			...
			if (properties != null)
				msgs = ((InternalEObject)properties).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MessagePackage.MESSAGE__PROPERTIES, null, msgs);
			if (newProperties != null)
				msgs = ((InternalEObject)newProperties).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MessagePackage.MESSAGE__PROPERTIES, null, msgs);
			msgs = basicSetProperties(newProperties, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MessagePackage.MESSAGE__PROPERTIES, newProperties, newProperties));
	}
	...
	public void setProviderId(String newProviderId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MessagePackage.MESSAGE__PROVIDER_ID, oldProviderId, providerId));
	}
	...
	public void setProviderName(String newProviderName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MessagePackage.MESSAGE__PROVIDER_NAME, oldProviderName, providerName));
	}
