...
public class BodyImpl extends EObjectImpl implements Body{
	...
	/**
	 * This is true if the Use File Ref attribute has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	public NotificationChain basicSetContent(EObject newContent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MessagePackage.BODY__CONTENT, oldContent, newContent);
	...
	public void setContent(EObject newContent) {
		if (newContent != content) {
			...
			if (content != null)
				msgs = ((InternalEObject)content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MessagePackage.BODY__CONTENT, null, msgs);
			if (newContent != null)
				msgs = ((InternalEObject)newContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MessagePackage.BODY__CONTENT, null, msgs);
	...
	public void setUseFileRef(boolean newUseFileRef) {
		...
		useFileRefESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MessagePackage.BODY__USE_FILE_REF, oldUseFileRef, useFileRef, !oldUseFileRefESet));
	}
	...
	public void unsetUseFileRef() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MessagePackage.BODY__USE_FILE_REF, oldUseFileRef, USE_FILE_REF_EDEFAULT, oldUseFileRefESet));
	}
	...
	public String toString() {
		...
		if (useFileRefESet) result.append(useFileRef); else result.append("<unset>");
		result.append(')');
