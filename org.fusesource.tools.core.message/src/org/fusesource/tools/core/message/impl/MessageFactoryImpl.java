...
public class MessageFactoryImpl extends EFactoryImpl implements MessageFactory {
	...
	public static MessageFactory init() {
		try {
			MessageFactory theMessageFactory = (MessageFactory)EPackage.Registry.INSTANCE.getEFactory("http://fuse.com/tools/message"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case MessagePackage.BODY: return createBody();
			case MessagePackage.DOCUMENT_ROOT: return createDocumentRoot();
			case MessagePackage.MESSAGE: return createMessage();
			case MessagePackage.PROPERTIES: return createProperties();
			case MessagePackage.PROPERTY: return createProperty();
			default:
