...
public class MessageUtil {
	...
	/**
	 * Standard Alert box will be run in the UI thread regardless of where it's
	 * called from
	 */
	...
	/**
	 * 
	 * Standard Alert box with info icon will be run in the UI thread regardless
	...
	/**
	 * 
	 * Standard Alert box with question icon will be run in the UI thread
	...
	/**
	 * 
	 * Standard Alert box with warning icon will be run in the UI thread
	 * regardless of where it's called from
	 */
	...
	/**
	 * Standard Alert box with error will be run in the UI thread regardless of
