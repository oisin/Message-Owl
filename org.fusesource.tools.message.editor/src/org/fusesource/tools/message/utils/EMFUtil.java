...
public class EMFUtil {
		...
		for (String key : keySet) {
			...
			for (Object object : newChildDescriptors) {
				...
				if (value instanceof Property) {
					...
					arrayList.add(CreateChildCommand.create(editingDomain, headers, ((CommandParameter) object),
							new StructuredSelection(headers).toList()));
				}
			}
		}
	...
	public static void loadHeadersAndMessgeAttributes(String type, Message message, EditingDomain editingDomain) {
		...
		IMessageTypeUI messageTypeUI = MessageExtensionsMgr.getInstance().getMessageTypeUIExtension(
