...
/**
 * This interface represents a provider instance. An entry point to plug-in a provider is through
 * WTP Server contribution Also see {@link MessagingServerDelegate} An entry point to get a provider
 * by the framework is through WTP Server contribution.
 */
public interface IProvider {
    ...
    /**
     * Return a map of connection parameters that is required to successfully connect to a server
     * Each key in the map will be populated in the messaging server runtime UI to take the user
     * inputs see {@link MessagingRuntimeWizardFragment}
     * 
     * @return
     */
