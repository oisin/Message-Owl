...
/**
 * This interface can be implemented by clients to subscribe to message change
 * events of a listener @see
 * {@link IMessagesManager#addMessageChangeListener(IMessageChangeListener)} The
 * IMessagesManager associated by the listener can be obtained from @see
 * {@link IListener#getMessagesManager()}
 * 
 * @author kiranb
 * 
 */
public interface IMessageChangeListener {
	...
	/**
	 * Fired when there is any change in the list of messages received by the
	 * listener
	 * 
	 * @param me
	 *            - Represents the MessageEvent - this event wraps the received
	 *            message in it
	 * @param kind
	 *            - Kind of the event
	 */
