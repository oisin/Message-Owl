...
public interface IConnection {
	...
	/**
	 * Clients should do the required initialization here to connect to the
	 * server
	 * 
	 ...
	 * @return
	 */
	public IDestination createDestination(IDestinationType type,
			String destinationName) throws MessagingException;
