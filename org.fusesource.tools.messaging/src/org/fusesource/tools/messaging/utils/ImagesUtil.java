...
/**
 * Contains a common images registry shared by all the Controls. The key to the common images
 * registry is the path of the image in the jar. Provides utility methods to load images from Jars.
 * 
 */
