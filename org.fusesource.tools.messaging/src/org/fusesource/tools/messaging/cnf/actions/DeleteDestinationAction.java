...
public class DeleteDestinationAction implements IObjectActionDelegate {
	...
	protected void deleteSender(IFile modelFile) throws MessagingException {
		boolean openConfirm = MessageDialog.openConfirm(Display.getCurrent().getActiveShell(), "Confirm", "Are you sure you want to delete the Sender?");
		if (!openConfirm)
			return;
	...
	protected void deleteListener(IFile modelFile) throws MessagingException {
		boolean openConfirm = MessageDialog.openConfirm(Display.getCurrent().getActiveShell(), "Confirm", "Are you sure you want to delete the Listener?");
		if (!openConfirm)
			return;
