...
/**
 * Abstract implementation of IConnection for JMS. Clients should provide
 * implementation for initialize method and use the connection properties to
 * create a provider specific JMS Connection. By Default creates a NON-
 * TRANSACTED & AUTO ACK JMS session
 * 
 * @author kiranb
 * 
 */
