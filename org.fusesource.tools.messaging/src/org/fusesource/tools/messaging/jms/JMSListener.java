...
/**
 * Default implementation of IListener for JMS Creates MessageConsumers and
 * provides functionality for start()/stop() methods. When a message arrives to
 * onMessage() - the message will be added to the MessagesManager and thus it
 * notifies all interested parties about the new message arrival event
 * 
 * In addition to the basic functionality, this class extends the
 * JMSLabelProvider to customize the display of a listener in the Project
 * Explorer Eg. Shows a message selector in brackets when a message selector is
 * set on a listener
 * 
 * @author kiranb
 * 
