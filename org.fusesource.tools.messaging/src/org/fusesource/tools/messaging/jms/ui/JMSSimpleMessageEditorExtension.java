...
public class JMSSimpleMessageEditorExtension extends SimpleMessageEditorExtension {
    ...
    @Override
    protected Composite createPropertiesTab(Composite parent, final EditingDomain editingDomain) {
    ...
    protected void setReplyToDest(ReplyToInfo replyToInfo) {
        modifyProperty(replyToInfo == null ? "" : replyToInfo.toString(), replyToProperty, MessagePackage.eINSTANCE
                .getProperty_Value());
    }
    ...
    protected void buildTable(final TableViewer tableViewer, Group group, final EditingDomain editingDomain,
        ...
        editors[1].addListener(new ICellEditorListener() {
            ...
            public void editorValueChanged(boolean oldValidState, boolean newValidState) {
                ...
                modifyProperty((String) editors[1].getValue(), property, MessagePackage.eINSTANCE.getProperty_Value());
            }
        });
    ...
    protected void buildPropertiesSection(final TableViewer tableViewer, Group group, Table table,
        ...
        public boolean canModify(Object element, String property) {
            if (element instanceof Property) {
                ...
                if (prop.isIsheader()) {
                    ...
                    if (!(JMSConstants.JMSCORRELATION_ID.equals(name) || JMSConstants.JMSREPLY_TO.equals(name) || JMSConstants.JMSTYPE
                            .equals(name))) {
                        return false;
                    } else {
                        return true;
