...
public class JMSSimpleMessageDelegate {
	...
	public Message getJMSMessage(org.fusesource.tools.core.message.Message simpleMessage, JMSSender sender) throws MessagingException {
	...
	public Message getJMSMessage(org.fusesource.tools.core.message.Message simpleMessage, Session session) throws MessagingException {
		Message jmsMessage;
		try {
	...
	/**
	 * Gets all headers and properties as Properties By default sets all
	 * properties as StringProperties and required headers as JMS Headers.
	 * 
	 * @param simpleMessage
	 * @param jmsMessage
	 * @param session
	 ...
	 * @throws JMSException
	 */
	protected void populateHeadersAndProperties(org.fusesource.tools.core.message.Message simpleMessage, Message jmsMessage, Session session)
			throws JMSException {
