		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_providerId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_providerId_feature", "_UI_Message_type"),
				 MessagePackage.Literals.MESSAGE__PROVIDER_ID,
				 true,
				 false,
				 false,
	...
	protected void addProviderNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_providerName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_providerName_feature", "_UI_Message_type"),
				 MessagePackage.Literals.MESSAGE__PROVIDER_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MessagePackage.Literals.MESSAGE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MessagePackage.Literals.MESSAGE__PROPERTIES,
				 MessageFactory.eINSTANCE.createProperties()));

		newChildDescriptors.add
			(createChildParameter
				(MessagePackage.Literals.MESSAGE__BODY,
				 MessageFactory.eINSTANCE.createBody()));
	}
